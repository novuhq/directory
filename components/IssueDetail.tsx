          ...
          <div className="space-y-4 bg-background rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  {issue.technicalDesign?.map((design, index) => (
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center -space-x-4">
                  {issue.teamMembers?.map((member, index) => (
                    <Avatar
                      key={index}
                      className="h-[28px] w-[28px] border-2 border-background"
                    >
          ...
          <div className="flex items-center gap-2 space-y-2">
            <div className="flex items-center">
              ...
              >
                ...
                <span className="text-sm">{issue.priority} Priority</span>
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 space-y-2">
            <div className="flex items-center">
              ...
              >
                ...
                <span className="text-sm">{issue.estimate}</span>
              </button>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <span className="text-sm">{issue.cycle}</span>
              </button>
            </div>
          </div>
