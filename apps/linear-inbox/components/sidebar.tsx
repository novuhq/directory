    ...
    <div className="w-56 border-r border-zinc-200 bg-[lch(96.667%_0_282.863/1)] flex flex-col h-full overflow-y-auto">
      ...
      <div className="px-2 mt-2 space-y-1">
        <Link href="/">
          <Button
            variant="ghost"
            className="w-full justify-start gap-2 text-sm h-10 bg-zinc-100 text-zinc-900"
          >
        ...
        <Button
          variant="ghost"
          className="w-full justify-start gap-2 text-sm h-10 text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 blur-[2px]"
        >
      ...
      <div className="mt-auto px-3 pb-3">
        <Link href="/preferences">
          <Button
            variant="ghost"
            className="w-full justify-start gap-2 text-sm h-10 text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100"
          >
