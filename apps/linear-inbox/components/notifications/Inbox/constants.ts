...
export const DEFAULT_APPLICATION_ID =
  process.env.NEXT_PUBLIC_NOVU_APPLICATION_ID;
export const DEFAULT_SUBSCRIBER_ID = process.env.NEXT_PUBLIC_NOVU_SUBSCRIBER_ID;
