...
export const NotificationActionIcon: React.FC<NotificationActionIconProps> = ({ notification }) => {
  ...
  switch (iconType) {
    case 'completed':
      return <CheckCircle className="w-3.5 h-3.5 text-green-500" aria-label="Completed" />;
    case 'mentioned':
      return <AtSign className="w-3.5 h-3.5 text-blue-500" aria-label="Mentioned" />;
    case 'assigned':
      return <ArrowRight className="w-3.5 h-3.5 text-purple-500" aria-label="Assigned" />;
    case 'replied':
      return <CornerUpLeft className="w-3.5 h-3.5 text-cyan-500" aria-label="Replied" />;
    case 'commented':
      return <MessageSquare className="w-3.5 h-3.5 text-blue-400" aria-label="Commented" />;
    case 'canceled':
      return <XCircle className="w-3.5 h-3.5 text-red-500" aria-label="Canceled" />;
    case 'overdue':
