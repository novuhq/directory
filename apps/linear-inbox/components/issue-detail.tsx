...
import { archiveNotification } from "@/hooks/novuHooks";
...
export function IssueDetail({ issueId, issueTitle, className, notification }: IssueDetailProps) {

  // Create safe versions of nested data to prevent rendering errors
  ...
  const activity = [
    {
      ...
      action: "commented",
      time: "2 hours ago",
      avatarUrl: "https://public.linear.app/f13f1996-c9b0-4fea-8ee7-2c3faf6a832d/af212def-41f3-474c-bb08-a7d36e06922b/87d2e8d4-9ff7-4566-9d6a-3240ad17f546"
    },
    {
      user: "Paweł",
      action: "updated the status to In Progress",
      time: "1 day ago",
      avatarUrl: "https://public.linear.app/f13f1996-c9b0-4fea-8ee7-2c3faf6a832d/b10238ef-973b-4a47-a143-df08594c502f/d5e789f7-4470-4a1f-83d1-f0cfa9153d50"
    },
    {
      user: "Team",
    ...
    <div className={cn("h-full flex flex-col bg-background", className)}>
      ...
      <div className="flex items-center justify-between p-3 border-b">
        <div className="flex items-center gap-1">
          <span className="text-md font-medium text-muted-foreground">Vast.craft</span>
          {notification && (
            <div className="flex items-center gap-1">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="text-muted-foreground">
                <path d="M6.5 3.5L10.5 7.5L6.5 11.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
              </svg>
              <span className="text-md font-medium text-muted-foreground">{issueId}</span>
            </div>
          )}
        </div>
        ...
        <div className="flex-1 overflow-auto p-4 pl-8 space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="sm" onClick={handleUnsubscribe}>Unsubscribe</Button>
                <div className="flex items-center -space-x-4">
                  <Avatar className="h-[28px] w-[28px] border-2 border-background">
                    <AvatarImage src="https://public.linear.app/f13f1996-c9b0-4fea-8ee7-2c3faf6a832d/af212def-41f3-474c-bb08-a7d36e06922b/87d2e8d4-9ff7-4566-9d6a-3240ad17f546" alt="Avatar of Paweł Tymczuk" />
                    <AvatarFallback>PT</AvatarFallback>
                  </Avatar>
                  <Avatar className="h-[28px] w-[28px] border-2 border-background">
                    <AvatarImage src="https://public.linear.app/f13f1996-c9b0-4fea-8ee7-2c3faf6a832d/af212def-41f3-474c-bb08-a7d36e06922b/87d2e8d4-9ff7-4566-9d6a-3240ad17f546" alt="Avatar of Radoslaw Gozdzialski" />
                ...
                <div key={index} className="flex items-start gap-3">
                  ...
                  <div className="flex-1 overflow-hidden">
                    <div className="flex items-center gap-1 text-muted-foreground">
                      <button className="hover:text-foreground transition-colors">{item.user}</button>
                      <span>{item.action}</span>
                      <span>•</span>
                      <button className="hover:text-foreground transition-colors">{item.time}</button>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div className="w-64 border-l p-4 space-y-3">
            ...
            <div className="flex items-center">
              ...
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" >
                  <circle cx="7" cy="7" r="6" fill="none" stroke="currentColor" strokeWidth="1.5"></circle>
                </svg>
          ...
          <div className="flex items-center gap-2 space-y-2">
            <div className="flex items-center">
              <button 
                ...
                onClick={(e) => { e.preventDefault(); e.stopPropagation(); }}
              >
                <svg aria-label="No Priority" width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="text-muted-foreground">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              ...
              >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="text-muted-foreground">
                  <path fillRule="evenodd" clipRule="evenodd" d="M10.2105 4C10.6337 4 11.0126 4.18857 11.24 4.48L14 8L11.24 11.52C11.0126 11.8114 10.6337 12 10.2105 12L3.26316 11.9943C2.56842 11.9943 2 11.4857 2 10.8571V5.14286C2 4.51429 2.56842 4.00571 3.26316 4.00571L10.2105 4ZM11.125 9C11.6773 9 12.125 8.55228 12.125 8C12.125 7.44772 11.6773 7 11.125 7C10.5727 7 10.125 7.44772 10.125 8C10.125 8.55228 10.5727 9 11.125 9Z"></path>
                </svg>
