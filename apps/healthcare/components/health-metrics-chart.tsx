      ...
      <div className="h-[300px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={heartRateData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <YAxis domain={[60, 80]} />
            <Tooltip />
            <Line type="monotone" dataKey="value" stroke="#0ea5e9" name="Heart Rate (bpm)" strokeWidth={2} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    )
      ...
      <div className="h-[300px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={bloodPressureData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <Tooltip />
            <Legend />
            <Line type="monotone" dataKey="systolic" stroke="#0ea5e9" name="Systolic" strokeWidth={2} />
            <Line type="monotone" dataKey="diastolic" stroke="#6366f1" name="Diastolic" strokeWidth={2} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    )
      ...
      <div className="h-[300px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={temperatureData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <YAxis domain={[98, 99]} />
            <Tooltip />
            <Line type="monotone" dataKey="value" stroke="#0ea5e9" name="Temperature (°F)" strokeWidth={2} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    )
